...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default="Sherlock_sft_dir",
                      help='Path to the model directory')
    parser.add_argument('--input_file', type=str, default="randomly_sampled_data_dir",
                      help='Path to input JSON file')
    parser.add_argument('--output_file', type=str, default="./train/LLaMA-Factory/data/sherlock_offline.json",
