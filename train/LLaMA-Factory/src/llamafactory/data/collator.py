...
class MultiModalDataCollatorForSeq2Seq(DataCollatorForSeq2Seq):
    ...
    def __call__(self, features: Sequence[Dict[str, Any]]) -> Dict[str, "torch.Tensor"]:
        ...
        #     features["weights"] = torch.tensor(features["weights"]).float().expand(features["input_ids"].shape)
        return features
...
@dataclass
class RefineDataCollatorWithPadding(MultiModalDataCollatorForSeq2Seq):
    r"""
    ...
    def __call__(self, features: Sequence[Dict[str, Any]]) -> Dict[str, "torch.Tensor"]:
        ...
        for key in ("chosen", "rejected", "chosen_refined_w", "chosen_refined_l", "chosen_correction_w", "chosen_correction_l", "rejected_refined_w", "rejected_refined_l", "rejected_correction_w", "rejected_correction_l"):
            for feature in features:
                target_feature = {
