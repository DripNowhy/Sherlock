...
class SharegptDatasetConverter(DatasetConverter):
    def __call__(self, example: Dict[str, Any]) -> Dict[str, Any]:
        ...
        output = {
            ...
            "_response": response,
            "_system": system,
            "_prefix": example[self.dataset_attr.prefix] if self.dataset_attr.prefix else "",
            "_prefix_l": example[self.dataset_attr.prefix_l] if self.dataset_attr.prefix_l else "",
            "_weights": example[self.dataset_attr.weights] if self.dataset_attr.weights else None,
            "_tools": example[self.dataset_attr.tools] if self.dataset_attr.tools else "",
            "_images": self._find_medias(example[self.dataset_attr.images]) if self.dataset_attr.images else None,
            "_videos": self._find_medias(example[self.dataset_attr.videos]) if self.dataset_attr.videos else None,
            "_audios": self._find_medias(example[self.dataset_attr.audios]) if self.dataset_attr.audios else None,
